...
using MelonLoader;
using BuildInfo = SilentWalker.BuildInfo;
...
[assembly: MelonInfo(typeof(SilentWalker.Main), BuildInfo.GUIName, BuildInfo.Version, BuildInfo.Author, BuildInfo.DownloadLink)]
